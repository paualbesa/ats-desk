...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red ATS Desk en progreso..."),
        ...
        ("Grid connections open in tab window", "Las conexiones se abren en la ventana de pestañas. Use las pestañas para ver cada equipo."),
        ("Add to shared list", "Añadir a la lista compartida"),
        ("Name", "Nombre"),
        ...
        ("Show RustDesk", "Mostrar ATS Desk"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("powered_by_me", "Con tecnología de ATS Desk"),
        ...
        ("About RustDesk", "Acerca de ATS Desk"),

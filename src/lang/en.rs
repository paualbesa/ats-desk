...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the ATS Desk network..."),
        ...
        ("Grid connections open in tab window", "Connections open in the tab window. Use the tabs to see each computer."),
        ...
        ("powered_by_me", "Powered by ATS Desk"),

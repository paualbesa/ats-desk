...
export const DeskConfig = {
  rendezvousServer: process.env.EXPO_PUBLIC_DESK_ID_SERVER ?? '169.155.235.85:21116',
  relayServer: process.env.EXPO_PUBLIC_DESK_RELAY_SERVER ?? '169.155.235.85:21117',
  serverKey:
